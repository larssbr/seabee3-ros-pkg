"""autogenerated by genmsg_py from MatchContoursActionResult.msg. Do not edit."""
...
class MatchContoursActionResult(roslib.message.Message):
  _md5sum = "075b6ff149ed05b7f463af4c1578b9d9"
  _type = "seabee3_actions/MatchContoursActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','seabee3_actions/MatchContoursResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MatchContoursActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = seabee3_actions.msg.MatchContoursResult()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = seabee3_actions.msg.MatchContoursResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.matches)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.matches:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.matches.append(val1)
      return self
