"""autogenerated by genmsg_py from ConfigureActionFeedback.msg. Do not edit."""
...
class ConfigureActionFeedback(roslib.message.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "seabee3_actions/ConfigureActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','seabee3_actions/ConfigureFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ConfigureActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = seabee3_actions.msg.ConfigureFeedback()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = seabee3_actions.msg.ConfigureFeedback()
