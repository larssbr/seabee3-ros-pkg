"""autogenerated by genmsg_py from MakeTrajectoryResult.msg. Do not edit."""
...
class MakeTrajectoryResult(roslib.message.Message):
  _md5sum = "49e61c5b4c8b3fda4e52162249fe7f91"
  _type = "seabee3_actions/MakeTrajectoryResult"
...
"""
  ...
  _slot_types = ['seabee3_msgs/Trajectory']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MakeTrajectoryResult, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.trajectory is None:
        self.trajectory = seabee3_msgs.msg.Trajectory()
    else:
      self.trajectory = seabee3_msgs.msg.Trajectory()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.trajectory.intervals)
      buff.write(_struct_I.pack(length))
      for val1 in self.trajectory.intervals:
        _v1 = val1.length
        _x = _v1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.trajectory.intervals.append(val1)
      return self
